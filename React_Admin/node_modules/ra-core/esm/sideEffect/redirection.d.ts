 ...
 */
export declare function handleRedirection({ payload, requestPayload, meta: { basePath, redirectTo }, }: ActionWithSideEffect): Generator<import("redux-saga/effects").PutEffect<import("connected-react-router").CallHistoryMethodAction<[string, {}?]>> | import("redux-saga/effects").PutEffect<import("../actions/uiActions").RefreshViewAction>, void, unknown>;
