...
export var TranslatableInputsTabs = function (props) {
    ...
    return (React.createElement(AppBar, { color: "default", position: "static", className: classes.root },
        React.createElement(Tabs, __assign({ value: selectedLocale, onChange: handleChange, indicatorColor: "primary", textColor: "primary" }, tabsProps), locales.map(function (locale) { return (React.createElement(TranslatableInputsTab, { key: locale, value: locale, locale: locale, groupKey: groupKey })); }))));
};
