...
import { linkToRecord, sanitizeListRestProps, useListContext, useResourceContext, } from 'ra-core';
...
var SingleFieldList = function (props) {
    ...
    var _b = useListContext(props), ids = _b.ids, data = _b.data, loaded = _b.loaded, basePath = _b.basePath;
