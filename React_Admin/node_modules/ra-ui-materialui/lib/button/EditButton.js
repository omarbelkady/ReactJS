...
var EditButton = function (_a) {
    ...
    return (React.createElement(Button_1.default, __assign({ component: react_router_dom_1.Link, to: ra_core_1.linkToRecord(basePath, record && record.id), label: label, onClick: stopPropagation }, rest), icon));
};
