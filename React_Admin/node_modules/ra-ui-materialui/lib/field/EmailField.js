...
var EmailField = react_1.memo(function (_a) {
    ...
    return (React.createElement(core_1.Link, __assign({ className: className, href: "mailto:" + value, onClick: stopPropagation }, sanitizeFieldRestProps_1.default(rest)), value));
});
