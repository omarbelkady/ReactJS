 ...
 */
exports.TranslatableFieldsTab = function (props) {
    var locale = props.locale, _a = props.groupKey, groupKey = _a === void 0 ? '' : _a, rest = __rest(props, ["locale", "groupKey"]);
    var translate = ra_core_1.useTranslate();
    return (react_1.default.createElement(Tab_1.default, __assign({ id: "translatable-header-" + groupKey + locale, label: translate("ra.locales." + groupKey + locale, {
