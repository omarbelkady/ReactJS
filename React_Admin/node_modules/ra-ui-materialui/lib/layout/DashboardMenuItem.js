...
var DashboardMenuItem = function (_a) {
    ...
    return (React.createElement(MenuItemLink_1.default, __assign({ onClick: onClick, to: "/", primaryText: translate('ra.page.dashboard'), leftIcon: React.createElement(Dashboard_1.default, null), exact: true }, props)));
};
